...
export class LineInGame extends LineInGameBase {
    ...
    _onShowWinValue(lineNumber, symbols, credit, allowArray) {
        ...
        this._winValuePanel.bg.width = /*(this._winValuePanel.text.width > this._winValuePanel.bg.saveWidth) ?
            this._winValuePanel.text.width + 20 :
            this._winValuePanel.bg.saveWidth;*/this._winValuePanel.text.width + 20;
